...
<link rel="stylesheet" href="/quanlydoan/assets/css/profileadmin.css">
...
<div class="admin-profile-container">
    ...
    <form id="profileForm" method="POST" action="/quanlydoan/admin/updateProfile" enctype="multipart/form-data" class="needs-validation" novalidate>
...
<script src="/quanlydoan/assets/js/profileadmin.js"></script>